...
const userApi = {
  ...
  get: (payload) => axiosClient.get(`/user/${payload}`),
  ...
  updateFeedback: (payload) =>
    axiosClient.put("/user/feedback/update", payload),

  createNotification: (payload) =>
    axiosClient.post("/user/notification/create", payload),
  getNotification: (payload) =>
    axiosClient.post("/user/notification/get", payload),
};
